...
Module Program
    ...
    Public SAHSRootFolder As String

    Sub Main(args As String())

        IRISRootFolder = ConfigurationManager.AppSettings("IRISRootFolder")
        SAHSRootFolder = ConfigurationManager.AppSettings("SAHSRootFolder")
        '-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
        ...
        For Each Item In Items
            ...
            '-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
            Dim TopFolder As String() = IO.Directory.GetDirectories(SAHSRootFolder, Item.FileReference.Substring(5, 2))
            If TopFolder.Length = 0 Then
                TopFolder = IO.Directory.GetDirectories(SAHSRootFolder, Item.FileReference.Substring(0, 7) & "*")
            End If
